...
from middle_adj import MiddleAdj
...
def main():
    try:
        ...
        print("BSTONE")
        middle_adj_runner = MiddleAdj()


        aCode , direction = a_runner.aArea(code="A-2")
        #print(direction)
        a_runner.scrue()
        #aCode="A-1"
        #direction="right"
        ...
        if direction == "left":
            ...
            #B区
            # b_stone_runner.turn_to_direction(180)
            # b_stone_runner.turn_to_direction(270)
            # middle_adj_runner.middleAdj()

            a_runner.bArea(direction,code="B-2")

            # b_stone_runner.turn_to_direction(180)
            # b_stone_runner.turn_to_direction(90)
            # middle_adj_runner.middleAdj()
...
class A_Scrue:
    def aArea(self,code="A-1"):
        ...
        aCode , direction = qr_runner.qrReadA(defult_code=code)
        return aCode , direction
