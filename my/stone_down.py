...
def main():
    ...
    try:
        ...
        for step in steps['step']:
            ...
            lcm_cmd.publish("robot_control_cmd", msg.encode())
            time.sleep(0.1)
        for i in range(80):  # 15s Heat beat It is used to maintain the heartbeat when life count is not updated
            lcm_cmd.publish("robot_control_cmd", msg.encode())
            print(f"wait{i}")
            time.sleep(0.2)
        ...
        try:
           ...
           # print(usergait_msg.data)
            ...
            for step in steps['step']:
                ...
                lcm_cmd.publish("robot_control_cmd", msg.encode())
                time.sleep(0.1)
            for i in range(99):  # 15s Heat beat It is used to maintain the heartbeat when life count is not updated
                lcm_cmd.publish("robot_control_cmd", msg.encode())
                print(f"wait{i}")
                time.sleep(0.2)
            # msg.mode = 11 # Locomotion
            ...
            for step in steps['step']:
                ...
                lcm_cmd.publish("robot_control_cmd", msg.encode())
                time.sleep(0.1)
            for i in range(78):  # 15s Heat beat It is used to maintain the heartbeat when life count is not updated
                lcm_cmd.publish("robot_control_cmd", msg.encode())
                print(f"wait{i}")
                time.sleep(0.2)
